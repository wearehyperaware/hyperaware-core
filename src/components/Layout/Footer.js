                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                                <Link className="logo-footer" to="#">Hyperaware<span
                                ...
                                <ul className="list-unstyled social-icon social mb-0 mt-4">
                                    <li className="list-inline-item"><Link to="#" className="rounded mr-1"><i
                                        className="mdi mdi-instagram" title="Instagram"></i></Link></li>
                                    <li className="list-inline-item"><Link to="#" className="rounded"><i
                                        className="mdi mdi-twitter" title="Twitter"></i></Link></li>
                                </ul>
                            </div>
                            ...
                            <div className="col-lg-2 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                ...
                                <ul className="list-unstyled footer-list mt-4">
                                    <li><Link to="#" className="text-muted"><i
                                        className="mdi mdi-chevron-right mr-1"></i> About Us</Link></li>
                                    <li><Link to="#" className="text-muted"><i
                                        className="mdi mdi-chevron-right mr-1"></i> Services</Link></li>
                                    <li><Link to="#" className="text-muted"><i
                                        className="mdi mdi-chevron-right mr-1"></i> Team</Link></li>
                                    <li><Link to="#" className="text-muted"><i
                                        className="mdi mdi-chevron-right mr-1"></i> Features</Link></li>
                                    <li><Link to="#" className="text-muted"><i
                                        className="mdi mdi-chevron-right mr-1"></i> FAQ</Link></li>
                                    <li><Link to="#" className="text-muted"><i
                            ...
                            <div className="col-lg-3 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                ...
                                <ul className="list-unstyled footer-list mt-4">
                                    <li><Link to="#" className="text-muted"><i
                                        className="mdi mdi-chevron-right mr-1"></i> Demo</Link></li>
                                    <li><Link to="#" className="text-muted"><i
                                        ...
                                        <div className="col-lg-12">
                                            <div className="foot-subscribe form-group position-relative">
                                                ...
                                                <input type="email" name="email" id="emailsubscribe"
                                                       className="form-control pl-5 rounded" placeholder="Your email : "
                                                       required/>
                                            </div>
                                        </div>
                                        <div className="col-lg-12">
                                            <input type="submit" id="submitsubscribe" name="send"
                                                   className="btn btn-primary w-100" value="Subscribe"/>
                                        </div>
                                    </div>
                                </form>
                            </div>
