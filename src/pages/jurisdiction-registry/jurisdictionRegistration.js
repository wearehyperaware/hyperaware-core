...
export class RegisterJurisdiction extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            someHash: "0x6b22041934973b8dc2d68181b87f18ef085f739c793a99dd72062f97ec4e3c4f",
            methods: null,
    ...
    initContract = async () => {
        ...
        this.state.zoneRegistryContract = new this.state.web3.eth.Contract(zoneContract.abi, zoneContract.address);
    ...
    clearForm = () => {
        ...
        d3.selectAll('.is-valid')
            .classed('is-valid', false);
        
        d3.selectAll('.is-invalid')
            .classed('is-invalid', false);
    ...
    registerDID = async (event) => {
        ...
        let zones = await Promise.all(this.state.zones.map( async (zone) => {
            let zoneToDeploy = zone;

            if (!zoneToDeploy.serviceEndpoint) {

                let geojsonURI = await this.saveToArweave(JSON.stringify(zone.geojson));
        ...
        let didHash = this.state.web3.utils.keccak256(JSON.stringify(didDocToRegister));
                ...
                <Col lg={7} style={{width: '550px', marginTop: '110px', marginLeft: '66.5%', marginBottom: "40px"}}>
                    ...
                    <div className="studio-home bg-white shadow mt-4 " style={{paddingTop: '16px', paddingLeft: '8px'}}>
                        ...
                        <AnimateHeight duration={500} height={this.state.heightZonesCard}>
                            <div>
                            <div className='card' style={{marginLeft: '40px', marginBottom: '3rem'}}>
                                <div className='card-header'>Register new zone.
                                </div>
                                    ...
                                    <form id="zone-form">
                                        <div className="row">
                                            <div className="col-lg">
                                                <div className="form-row">
                                                    <div className="form-group col-md">
                                                        ...
                                                        <input type="text" className="form-control"
                                                            ...
                                                            onChange={event => this.setState({zoneName: event.target.value})}
                                                            />
                                                    </div>
                                                </div>
                                                <div className="form-row">
                                                    <div className="form-group col-md">
                                                        <label htmlFor="inputOwnerDID">Zone geometry</label>
                                                        <input type="file" id="geojson-input" className="form-control "
                                                ...
                                                <div className="form-row">
                                                    <div className="form-group col-md">
                                                        <label htmlFor="inputOwnerDID">Zone administrator</label>
                                                        <input type="text" className="form-control"
                                                            placeholder="Transport for London"
                                                            onChange={event => this.setState({zoneAdmin: event.target.value})}
                                                            />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="form-row">
                                                    <div className="form-group col-md">
                                                        <label htmlFor="inputOwnerDID">Beneficiary IoTeX address</label>
                                                        <input type="text" className="form-control"
                                                            placeholder="io435df3531zd315713aD414..."
                                                            onChange={event => this.setState({zoneBeneficiary: event.target.value})}
                                                            />
                                                    </div>
                                                </div>
                                                <div className="form-row">
                                                    <div className="form-group col-6">
                                                        <label htmlFor="inputOwnerDID">Charge / minute </label>
                                                        <input type="text" className="form-control"
                                                            placeholder="0.70"
                                                            onChange={event => this.setState({zoneCharge: event.target.value})}
                                                            />
                                                    </div>
                                                    <div className="form-group col-6">
                                                        ...
                                                        <input type="text" className="form-control"
                                                            placeholder="GBP"
                                                            onChange={event => this.setState({zoneCurrency: event.target.value})}
                                                            />
                                                    </div>
                                                </div>
