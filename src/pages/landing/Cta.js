...
class Cta extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <section className="section bg-cta" style={{background: `url(${img2})`, backgroundPosition: "center"}}
                         id="cta">
                        ...
                        <Row className="justify-content-center">
                            <Col className="text-center">
                                <div className="section-title">
                                    <h4 className="main-title text-white mb-4">We Are Creative Dreamers and
                                        Innovators</h4>
